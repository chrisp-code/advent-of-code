...
func Y2021_Day2() {
	lines, err := utils.ReadLines("2021", "2")
	...
	year2021day2PartA(instructions)
	year2021day2PartB(instructions)
}
...
func year2021day2PartA(instructions []Instruction) {
	sub := LocationP1{0, 0}
	process(&sub, instructions)
	fmt.Printf("Day 2, Part A: %v\n", sub.location())
}

func year2021day2PartB(instructions []Instruction) {
