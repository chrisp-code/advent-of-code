...
func init() {
	Solutions["2021/3"] = Year2021_Day3
}

func Year2021_Day3() {
	lines, err := utils.ReadLines("2021", "3")

	if err != nil {
		log.Fatal(err)
	}

	year2021_day3_partA(lines)
	year2021_day3_partB(lines)
}
...
func year2021_day3_partA(lines []string) {
...
func year2021_day3_partB(lines []string) {
	report := computeReport(lines)
